...
def load_and_plot(path1, path2):
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(outdir, "bias_scatter.png"), dpi=300)
    plt.show()


if __name__ == '__main__':
    file1 = r'./Ratings/initial_prompts_with_responses_gpt_human_final.csv'
    file2 = r'./Ratings/gpt_response_with_ratings_updated.csv'
